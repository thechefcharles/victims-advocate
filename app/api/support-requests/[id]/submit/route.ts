/**
 * Domain 1.1 — SupportRequest: submit action.
...
import { submitSupportRequest } from "@/lib/server/supportRequests/supportRequestService";
...
export async function POST(req: Request, context: RouteParams) {
  try {
    ...
    const result = await submitSupportRequest(ctx, id, supabase);
