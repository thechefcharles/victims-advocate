/**
 * Domain 1.1 — SupportRequest: close action.
...
import { closeSupportRequest } from "@/lib/server/supportRequests/supportRequestService";
...
export async function POST(req: Request, context: RouteParams) {
  try {
    ...
    const result = await closeSupportRequest(ctx, id, supabase);
