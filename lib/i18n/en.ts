  ...
  home: {
    ...
    mkt: {
      ...
      hero: {
        ...
        ctaFootnote: "Free for survivors and advocates. No account required to explore the demo video.",
      ...
      problem: {
        label: "The problem",
        title: "Illinois's crime victim compensation system is under strain.",
        body:
          "Most applications are not denied because victims are ineligible. Many denials reflect process friction—missing documents, confusing requirements, missed deadlines, and lack of clear guidance. NxtStps is built to help survivors and advocates submit complete, consistent applications.",
      ...
      how: {
        ...
        step4Title: "Review before you submit",
        step4Body:
          "Checklists and validation help catch missing items and inconsistencies before materials go to the program.",
        step5Title: "Submit and stay coordinated",
        step5Body:
          "Applications and documents are organized for submission; survivors and advocates can continue to coordinate follow-up in the platform.",
      },
      convert: {
      ...
      about: {
        ...
        teamBody:
          "NxtStps combines victim services experience with product and compliance engineering—focused on Illinois Crime Victims Compensation first.",
