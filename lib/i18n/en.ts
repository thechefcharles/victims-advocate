...
export const en: I18nDict = {
  ...
  signup: {
    ...
    pageEyebrow: "Get started",
    pageTitle: "Create your account",
    pageSubtitle:
      "Set up a personal account first. If you lead an agency, choose Organization Leader—you’ll connect or propose your organization after you sign in, not during this step.",
    backHome: "← Back to home",
    accountTypeLabel: "How will you use NxtStps?",
    typeApplicant: "Applicant",
    typeAdvocate: "Advocate",
    typeOrganization: "Organization Leader",
    hintApplicant:
      "Personal tools and guided steps while you work on a compensation application or other support.",
    hintAdvocate: "Case tools for professionals who support applicants.",
    hintOrganization:
    ...
    orgSignupBefore: "Represent an organization? Choose",
    orgSignupAfter: "above—you’ll complete organization steps after you sign in.",
  ...
  applicantDashboard: {
    ...
    findOrganizationsPage: {
      ...
      organizationProfile: "View organization",
      visitWebsite: "Visit website",
      connectWithOrg: "Connect with this organization",
  ...
  home: {
    ...
    mkt: {
      nav: {
        ...
        pilotLine: "Chicago, IL · Pilot stage",
      ...
      hero: {
        ...
        stat2Num: "281 days",
        stat2Label: "median wait for payment",
        stat3Num: "3,677",
        stat3Label: "claims filed annually in IL",
        source: "Source: 2025 peer-reviewed study of Illinois CVC claims (2012–2024, n=46,792).",
        ctaPrimary: "Start my application →",
        ctaDemo: "See a live demo ↓",
        ctaFootnote: "Free for survivors and advocates. No account required to try the demo on this page.",
        previewCaption: "↑ This is what it looks like. Try the real thing below ↓",
        previewStepLabel: "Step 2 of 7 · About 8 minutes remaining",
      },
      trust: {
        voca: "Built on VOCA and VAWA standards",
        compliance: "Compliance-first, GovTech-ready",
        pilot: "Piloting with Iglesia Santa Cruz, Chicago, IL",
        trauma: "Trauma-informed design throughout",
        encryption: "AES-256 encrypted · US-based servers",
      },
      demo: {
        label: "Live demo",
        title: "See how it works",
        subtitle: "Short overview—when you’re ready. Full interactive walkthrough coming soon.",
        disclaimer: "Demo mode · Video only · No account required",
        walkthroughSoon: "Full interactive walkthrough coming soon.",
      },
      interactiveDemo: {
        badge: "Live demo",
        title: "Try it now — no account needed",
        subtitle:
          "Walk through the first steps of an Illinois Crime Victims Compensation application. Nothing you enter here is saved.",
        regionLabel: "Illinois CVC interactive preview",
        topBarLeft: "NxtStps · Illinois CVC demo",
        topBarRight: "Demo mode · No data saved",
        progressLabel: "Demo steps",
        prog1: "Eligibility check",
        prog2: "About the incident",
        prog3: "Your next steps",
        s1Title: "Let’s see if Illinois CVC might fit your situation",
        s1Sub:
        ...
        s1Q: "Were you directly harmed by a violent crime in Illinois, or are you applying for a family member who was?",
        s1O1: "Yes — I’m applying for myself",
        s1O2: "Yes — I’m a family member applying for someone else",
        s1O3: "I’m not sure yet",
        s1Hint: "You can explore without choosing — or pick an answer to see how guidance changes.",
        s1Rv:
          "You may be in the right place. Illinois CVC covers many costs for eligible violent crime survivors. We’ll help you understand what to gather next.",
        s1Rf:
          "Family members may qualify in certain situations — for example when someone was killed or seriously injured. You’re in the right place to learn what applies.",
        s1Ru:
          "That’s common. A few more questions help clarify whether Illinois CVC is an option — there’s no wrong answer here.",
        toStep2: "Continue to step 2 →",
        skipReal: "Skip the demo — start my real application →",
        back: "← Back",
        s2Title: "Tell us about reporting",
        s2Ctx:
          "Illinois often expects cooperation with law enforcement. We’ll explain what counts as a report and what to do if you don’t have paperwork yet.",
        s2Q: "Was the crime reported to police (or another authority)?",
        s2O1: "Yes — it was reported",
        s2O2: "Not yet",
        s2O3: "I’m not sure",
        s2Ry:
          "Good. You’ll need a report or case number when you apply — we’ll show you exactly where to find it on the form.",
        s2Rn:
          "Illinois generally expects reporting within 72 hours, with important exceptions — for example sexual assault, domestic violence, and other situations.",
        s2RnNote: "You can still start an application if you’re past a deadline — we’ll help you explain your situation.",
        s2Ru:
          "That’s okay. A police report, order of protection, or hospital or shelter documentation may count. We’ll help you sort out what you have.",
        toStep3: "See your next steps →",
        s3Title: "Here’s what a real application often involves",
        s3Intro: "Based on your preview answers, here’s a sample checklist — not legal advice, and not saved.",
        s3L1: "Police report or case number",
        s3L2: "Medical bills (if you’re claiming medical costs)",
        s3L3: "Proof of lost wages (if applicable)",
        s3L4: "Relationship documentation (family applications)",
        s3EstTitle: "Time expectations (illustrative)",
        s3Est1Label: "Estimated time to complete",
        s3Est1Val: "15–25 minutes",
        s3Est2Label: "Typical processing with organized applications",
        s3Est2Val: "Often several months",
        s3Est3Label: "Illinois median wait (study data)",
        s3Est3Val: "281 days to payment",
        s3CtaStart: "Start my real application →",
        s3CtaHelp: "Request help from an advocate",
        s3Disclaimer: "This preview is for learning only. Nothing you selected is stored.",
        restart: "Start demo over",
      },
      videoTour: {
      ...
      audiences: {
        ...
        tabHospitals: "Hospitals & clinics",
        tabState: "State agencies",
        survivorsTitle: "You deserve support — we make it easier to reach",
        survivorsBody:
        ...
        survivorsCta: "Start my application →",
        survivorsB1: "Check eligibility in minutes",
        survivorsB2: "Apply in English or Spanish",
        ...
        advocatesCta: "Request a demo →",
        advocatesB1: "Fewer repetitive data-entry tasks",
        advocatesB2: "Higher completeness before submission",
        advocatesB3: "Flags missing items before they become denials",
        ...
        cbosB1: "Multi-staff, multi-program support",
        cbosB2: "Reporting-friendly activity history",
        cbosB3: "Outcome tracking for funders",
        cbosB4: "Warm referrals and handoffs",
        cbosB5: "Documentation that holds up to review",
        cbosB6: "Transparency for administering agencies",
        hospitalsTitle: "Start the paperwork path at the bedside",
        hospitalsBody:
          "Social workers and victim specialists can help patients begin a compensation application early — preserving timelines and reducing billing confusion later.",
        hospitalsCta: "Talk to us about hospital partnerships →",
        hospitalsB1: "Early intake that preserves filing windows",
        hospitalsB2: "Clear paths for billing and records requests",
        hospitalsB3: "HIPAA-adjacent handling for health information",
        hospitalsB4: "Dashboard-friendly for care teams",
        hospitalsB5: "Less back-and-forth with billing offices",
        hospitalsB6: "Helps patients access aid they may qualify for",
        stateTitle: "Cleaner applications — less back-and-forth",
        stateBody:
          "NxtStps is built as compliance-first infrastructure. Packets can arrive with stronger documentation, consistent formatting, and fewer preventable gaps.",
        stateCta: "Talk to us about your program →",
        stateB1: "Architecture aligned with VOCA / VAWA expectations",
        stateB2: "Pre-checks against common denial reasons",
        stateB3: "Structured data for federal reporting workflows",
        stateB4: "Designed with public audit lessons in mind",
        stateB5: "Integration path as programs mature",
        stateB6: "Aggregate views for oversight (where appropriate)",
      },
      denial: {
        label: "Denial prevention",
        title: "Most denials are preventable — we help you catch them early",
        body:
        ...
        d1Reason: "Missing documentation",
        d1Fix: "Smart checklist — requirements adjust as you answer questions",
        d1Tag: "Before you submit",
        d2Reason: "Late filing",
        d2Fix: "Deadline context and guidance when timelines are tight",
        d2Tag: "Before you submit",
        d3Reason: "Incomplete application",
        d3Fix: "Inline validation and cross-checks before you send anything",
        d3Tag: "Before you submit",
        d4Reason: "Missed follow-up",
        d4Fix: "Reminders on open tasks so requests don’t get lost",
        d4Tag: "Before you submit",
        d5Reason: "Ineligible expenses requested",
        d5Fix: "Coverage hints so you know what may not be reimbursable",
        d5Tag: "Before you submit",
        d6Reason: "Provider non-response",
        d6Fix: "Tracked document requests with follow-up status",
        d6Tag: "Before you submit",
        docHint: "See Help for product documentation and policies.",
      },
      problem: {
        label: "The problem",
        title: "Illinois's crime victim compensation system is strained — and survivors pay the price",
        body:
        ...
        card1Eyebrow: "2025 peer-reviewed study",
        card1Stat: "63%",
        card1Desc:
        ...
        card2Eyebrow: "2025 peer-reviewed study",
        card2Stat: "281 days",
        card2Desc: "median time between filing a claim and payment in the study data.",
        card3Eyebrow: "2024 DOJ OIG federal audit",
        card3Stat: "$125K",
        card3Desc:
          "in questioned costs cited in the federal audit of Illinois victim compensation grants, including manual processes and certification issues—as documented in the public report.",
        sources:
      ...
      how: {
        label: "How it works",
        title: "From first contact to a submitted application",
        step1Title: "Find the right organization",
        step1Body:
        ...
        step5Title: "Submit and stay coordinated",
        step5Body:
      ...
      convert: {
        ...
        subtitle: "Survivors, advocates, investors, and agency partners—choose the path that fits you.",
        survivorsTitle: "Start your application",
        survivorsBody: "Free, confidential. Illinois focus today.",
        survivorsCta: "Get started →",
        demoTitle: "Request a demo",
        demoBody: "Advocates, CBOs, hospitals—see the advocate workflow.",
        demoName: "Name",
        demoOrg: "Organization",
        demoEmail: "Email",
        demoRole: "What best describes you?",
        demoRoleAdvocate: "Advocate",
        demoRoleCbo: "CBO staff",
        demoRoleHospital: "Hospital social worker",
        demoRoleLe: "Law enforcement",
        demoRoleOther: "Other",
        demoSubmit: "Request demo",
        demoThanks: "Thank you—we’ll reach out within 24 hours.",
        investorsTitle: "Talk to the team",
        investorsBody: "Investors, accelerators, and state agency partners—we’d like to talk.",
        scheduleCta: "Schedule a conversation →",
        emailLine: "contact@nxtstps.org",
        seedLine: "NxtStps is raising a seed round.",
      },
      about: {
        label: "About",
        title: "Pilot and team",
        pilotLabel: "Current pilot partner",
        pilotName: "Iglesia Santa Cruz",
        pilotAddr: "6545 S Springfield Ave, Chicago, IL 60629",
        pilotDesc:
          "A faith-based community organization on Chicago’s Southwest Side serving a predominantly Latino neighborhood.",
        pilotStatus: "MOU executed · Pilot active",
        pilotTargets:
          "Pilot targets include high application completeness and reduced administrative burden for advocates—measured with the partner over time.",
        pilotCtaIntro: "Interested in a pilot partnership?",
        pilotCta: "Apply for a pilot partnership →",
        teamHeading: "Built by people close to the work",
        teamBody:
          "The idea took shape from frontline work: complex cases where language and process barriers kept people from the compensation they qualified for. NxtStps pairs that victim-services experience with product and compliance engineering—Illinois Crime Victims Compensation first.",
        founder1Name: "Sam Brandstrader",
        founder1Role: "CEO",
        founder1Bio: "Victim services and CVI experience; former Assistant Program Director, SWOP.",
        founder2Name: "Charlie Foreman",
        founder2Role: "CTO",
        founder2Bio: "Platform architecture, systems, and compliance infrastructure.",
        founder3Name: "Armando Mancilla",
        founder3Role: "CPO",
        founder3Bio: "Active CVI casework; guides product from frontline experience.",
        founder4Name: "Christina Rice",
        founder4Role: "CSO",
        founder4Bio: "Nonprofit leadership and organizational strategy.",
      ...
      footerMkt: {
        ...
        linkSurvivors: "For survivors",
        linkAdvocates: "For advocates",
        linkOrgs: "For organizations",
        linkDemo: "Request a demo",
        linkAbout: "About NxtStps",
        colLegal: "Legal",
        ...
        linkPilot: "Pilot partnerships",
        crisisIf: "If you need support:",
        crisis988: "988 Lifeline: call or text 988",
        crisisText: "Crisis Text Line: text HOME to 741741",
        crisis911: "Emergency: 911",
        bottomCopy: "© {year} NxtStps, LLC · Chicago, Illinois · All rights reserved",
        bottomChips: "VOCA · VAWA · HIPAA-adjacent · CJIS-aware · WCAG 2.2 AA",
      },
      stickyCrisis: "Support: 988 (call or text) · Crisis Text: HOME to 741741",
    },
  },
